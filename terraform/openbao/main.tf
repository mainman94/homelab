...
locals {
  secret_sources = ["cloudflare", "pocket-id", "pocket-id-users", "pocket-id-cloudflare-access", "github", "argocd", "grafana", "kargo", "smtp", "backblaze", "docker", "discord", "openrouter", "zot", "gitea", "network", "contact", "strapi"]
}
